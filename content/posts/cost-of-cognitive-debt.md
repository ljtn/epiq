...
It is easy to end up in one of two absolutes, either: traditional coding is dead, or, agentic worflows are non-deterministic and AI has no place in modern software development. There may be a third way, one that recognizes the problems, and addresses the risk in a methodical way.
