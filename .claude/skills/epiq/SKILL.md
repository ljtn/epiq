...
- **Findings from a code review get their own tickets**, tagged `review`, with the description saying which branch or PR the review covered — so the provenance survives even if the tag doesn't.
